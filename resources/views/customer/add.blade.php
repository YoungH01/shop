...
<div class="card">
    <div class="card-body">
       <h4 class="card-title">thêm customer</h4>
       <form class="forms-sample" method="POST" action="{{ route('customer.add.implement') }}">
         @csrf
          ...
          <button type="submit" class="btn btn-primary me-2">Thêm Customer</button>
       </form>
    </div>
 </div>
@endsection
